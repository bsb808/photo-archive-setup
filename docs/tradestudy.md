...
_Prepared 2026-05-29. Updated 2026-05-29 after reviewing the actual archive (see Section 12)._
...
4. **A cleanup pass belongs before indexing.** The trees carry artifacts that would clutter any gallery:
   ...
   - **15** stray non-photo files (`.bag`, `.mat`, `.m`, `.dcm`) that wandered in from robotics/MATLAB/medical work — move these out of the photo tree.
   These are safe to exclude at index time (Immich/PhotoPrism let you ignore patterns) and better to delete from the master once reviewed.
